...
const US_AUTOCOMPLETE_API_URL = "https://http://localhost:8000/fake/api/smartystreets/auto-complete"; //currently using in moveon code
...
const US_STREET_API_URL = "https://http://localhost:8000/fake/api/smartystreets/street-address"; //currently using in moveon code
const US_ZIP_CODE_API_URL = "https://http://localhost:8000/fake/api/smartystreets/zipcode-lookup"; //currently using in moveon code
